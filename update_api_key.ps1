# PowerShell script to update Gemini API key in DidactAI
...
Write-Host "ðŸ¤– DidactAI API Key Updater" -ForegroundColor Cyan
...
if (-not $ApiKey) {
    Write-Host "ðŸ”‘ Please enter your new Gemini API key:" -ForegroundColor Yellow
...
if ($djangoProcess) {
    ...
    Write-Host "ðŸ’¡ You can now start your Django server:" -ForegroundColor Yellow
    Write-Host "   python manage.py runserver" -ForegroundColor Gray
}

Write-Host "ðŸ§ª To test AI functionality, run:" -ForegroundColor Yellow
Write-Host "   python test_ai_refresh.py" -ForegroundColor Gray

Write-Host "`nðŸŽ‰ AI refresh complete!" -ForegroundColor Green
